...
The main finding is that the VAR model does not outperform the univariate AR model. In the Euro area, the seasonal AR(12) model performs best at short horizons, while in the U.S. the AR model clearly outperforms the VAR at longer forecast horizons.
